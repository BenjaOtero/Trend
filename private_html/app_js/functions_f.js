$(document).ready(function(){
    ...
    var ratPack = $.sammy(function() {
      ...
      this.get('#/gestion', function(context) {
            params={};
            params.action='gestion';
            $('#div-contenido').load("index.php", params, function(){
            });
      });   
